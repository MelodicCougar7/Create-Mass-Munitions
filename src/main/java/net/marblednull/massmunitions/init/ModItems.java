...
import net.marblednull.massmunitions.item.WhiskedGunpowderItem;
...
public class ModItems {
    ...
    //attempt 2 at importing mcreator code
    public static final RegistryObject<Item> WHISKED_GUNPOWDER_BUCKET = ITEMS.register("whiskedgunpowder_bucket", () -> new WhiskedGunpowderItem());
