    ...
    public static final RegistryObject<CreativeModeTab> MCORE = TABS.register("massmunitions",
            () -> CreativeModeTab.builder()
                    ...
                    .displayItems((displayParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.C260INGOT.get());
                        pOutput.accept(ModItems.C260NUGGET.get());
                        pOutput.accept(ModItems.C260SHEET.get());
                        pOutput.accept(ModItems.C260COIL.get());
                        pOutput.accept(ModItems.C260PLATE.get());
                        pOutput.accept(ModItems.INCOMPLETE9MMCASING.get());

                        pOutput.accept(ModItems.WHISKED_GUNPOWDER_BUCKET.get());
