...
public class ModBlocks {
    ...
    //public static final RegistryObject<LiquidBlock> WHISKED_GUNPOWDER_BLOCK = BLOCKS.register("whisked_gunpowder_block", () -> new LiquidBlock(ModFluids.WHISKED_GUNPOWDER_SOURCE, BlockBehaviour.Properties.copy(Blocks.WATER)));
